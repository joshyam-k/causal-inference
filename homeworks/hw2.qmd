...
In all of the above cases $(Y_i(1),Y_i(0)) \perp\!\!\!\!\perp$ does indeed imply these conditions, because of the fact that we would be able to drop the conditioning in all cases. That being said, it's possible that the terms just happen to cancel each other out without $(Y_i(1),Y_i(0)) \perp\!\!\!\!\perp$, as we will see in the next portion of this problem.
...
Of course $(Y_i(1),Y_i(0)) \perp\!\!\!\!\perp$ does not hold, because both $D$ and $Y_i(0)$ have a dependence on $X$. 
